...
her = media.Movie(		
						"Her",
						"In the not so distant future, Theodore, a lonely writer purchases a newly developed operating system designed to meet the user's every needs. ",
...
coherence = media.Movie(
						...
						"http://upload.wikimedia.org/wikipedia/en/9/9d/Coherence_2013_theatrical_poster.jpg",
